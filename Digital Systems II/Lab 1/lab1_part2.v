...
//Turns off All HEX5[]-HEX2[]
assign HEX5 = 8'b11111111;
assign HEX4 = 8'b11111111;
assign HEX3 = 8'b11111111;
assign HEX2 = 8'b11111111;

//Turns off decimals for HEX1[] and HEX0[]
assign HEX1[7] = 1;
assign HEX0[7] = 1;

//Assignments for HEX1[] based on SOP
assign HEX1[6] = 1;
...
//Assignments for HEX0[] based on SOP
assign HEX0[6] = (~SW[3]&~SW[2]&~SW[1])|(SW[3]&~SW[2]&SW[1])|(~SW[3]&SW[2]&SW[1]&SW[0]);
assign HEX0[5] = (~SW[3]&~SW[2]&SW[0])|(~SW[3]&~SW[2]&SW[1])|(~SW[3]&SW[1]&SW[0])|(SW[3]&SW[2]&~SW[1])|(~SW[2]&SW[1]&SW[0]);
